      ...
      <div className="w-full flex flex-col lg:flex-row items-start lg:items-center gap-10 lg:gap-0">
        <div className="flex-1 max-w-175">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <Link
              href={`/${movie.type.toLowerCase()}/${movie.slug}`}
              className="flex items-center gap-2.5 bg-primary hover:bg-red-600 text-white font-bold px-7 py-3.5 rounded-full transition-all duration-200 active:scale-95 shadow-lg shadow-red-900/40 text-sm tracking-wide uppercase hover:opacity-50"
            >
