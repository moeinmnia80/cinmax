...
export const HeroContent = () => {
  ...
  return (
    <div className="relative z-10 flex flex-1 items-center h-full">
      <div className="w-full flex flex-col lg:flex-row items-start lg:items-center gap-10 lg:gap-0">
        <div className="flex-1 max-w-150">
          <div className="flex items-center gap-3 mb-5 flex-wrap">
            <span
              className="bg-yellow-400 text-black text-xs font-black px-2 py-0.5 rounded-sm tracking-wide"
          ...
          <h1 className="text-[clamp(3rem,7.5vw,8rem)] font-black leading-none uppercase text-white mb-6">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <button
              onClick={() => redirect(`/movie/${movie.slug}`)}
            ...
            <button
              className="flex items-center gap-2.5 border border-white/40 hover:border-white/80 hover:bg-white/5 text-white/80 hover:text-white font-semibold px-7 py-3.5 rounded-full transition-all duration-200 text-sm tracking-wide uppercase"
              style={{
                fontFamily: "'Barlow Condensed', sans-serif",
                letterSpacing: "0.08em",
              }}
            >
              <Disc3 size={15} /> ${movie.price} Blu-ray
            </button>
          </div>
        </div>
        <div className="hidden lg:inline-block relative ml-auto">
          ...
          >
            <Image
              src="https://res.cloudinary.com/imsawsxo/image/upload/v1789909477/62cdb54445e73.webp"
              alt="poster"
              width={1920}
              height={1080}
            ...
            <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
              <span className="text-xs text-white/60 font-light">2024</span>
